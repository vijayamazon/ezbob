namespace Ezbob.API.AuthenticationAPI.Controllers {
	...
	using Ezbob.API.AuthenticationAPI.Results;
	...
	public class AccountController : ApiController {
		...
		private async Task<ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken) {
			...
			//Trace.WriteLine(string.Format("1------------VerifyExternalAccessToken----provider {0} accessToken {1}", provider, accessToken));
		...
		private JObject GenerateLocalAccessTokenResponse(string userName) {
			...
			//Trace.WriteLine(string.Format("2----GenerateLocalAccessTokenResponse----tokenResponse {0}", tokenResponse));
