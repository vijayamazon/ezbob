namespace landRegistry1
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "DaylistEnquiry";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.button1_Click);
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(48, 153);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(204, 48);
			this.button2.TabIndex = 1;
			this.button2.Text = "SearchByPropertyDescription";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(48, 239);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(207, 44);
			this.button3.TabIndex = 2;
			this.button3.Text = "OCWithSummary (RES)";
