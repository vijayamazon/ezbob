...
namespace com.yodlee.sampleapps
{
	...
	public class ContentServiceHelper : ApplicationSuper
    {
        ...
        public void viewAllContentServices()
        {
            ...
            Entry[] serviceMap = cst.getContentServicesByContainerType(getCobrandContext());
          ...
          public void printContentServiceInfo(ContentServiceInfo csi)
           {
               ...
               ContentServiceInfo[] sharedCSIDs =
                   cst.getContentServicesBySite(getCobrandContext(), csi.siteId, true);
           ...
           public void viewContainerServices()
           {
               ...
               if (isValid(choice))
               {
                   ContentServiceInfo[] csis = cst.getContentServicesByContainerType2(getCobrandContext(), choice);
                   if (csis != null)
                   {
                       printBriefContentServices(csis);
                   }
        ...
        public String getMfATypeId(long content_service_id)
        {
           ...
           return (csi.mfaType == null) ? null : csi.mfaType.GetType().ToString();
        }
    }
}
