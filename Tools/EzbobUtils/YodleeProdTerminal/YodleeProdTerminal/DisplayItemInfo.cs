...
namespace com.yodlee.sampleapps
{
	...
	public class DisplayItemInfo
	{
		...
		{
			System.Console.WriteLine("\tItem identifier: {0}",
					   itemSummary.itemId);
			System.Console.WriteLine("\tItem display name: {0}",
					   itemSummary.itemDisplayName);
			System.Console.WriteLine("\tContainer type: {0}",
					   itemSummary.contentServiceInfo.containerInfo.containerName);
			System.Console.WriteLine("\tContent Service Name: {0}",
					   itemSummary.contentServiceInfo.siteDisplayName);
			System.Console.WriteLine("\tLast updated time (U1TC seconds): {0}",
					   itemSummary.refreshInfo.lastUpdatedTime);
			System.Console.WriteLine("\tLast update attempt time (UTC seconds): {0}",
					   itemSummary.refreshInfo.lastUpdateAttemptTime);
			System.Console.WriteLine("\tRefresh status code: {0}",
