		...
		private void OnlineTurnovers() {
			if (!Trail.MyInputData.HasOnline && Trail.MyInputData.HasHmrc) {
				StepDone<OnlineTurnoverAge>()
					.Init(Trail.MyInputData.HasOnline);
				return;
			} // if

			if (Trail.MyInputData.IsOnlineTurnoverTooOld()) {
				StepFailed<OnlineTurnoverAge>()
					.Init(Trail.MyInputData.OnlineUpdateTime, Trail.MyInputData.DataAsOf);
			} else {
				StepDone<OnlineTurnoverAge>()
					.Init(Trail.MyInputData.OnlineUpdateTime, Trail.MyInputData.DataAsOf);
			}
			...
			if (Trail.MyInputData.IsOnlineTurnoverGood(1)) {
				StepDone<OnlineOneMonthTurnover>()
					.Init(Trail.MyInputData.OnlineTurnover1M, Trail.MyInputData.OnlineTurnover1Y, Trail.MyInputData.Configuration.OnlineTurnoverDropMonthRatio);
			} else {
			...
			if (Trail.MyInputData.IsOnlineTurnoverGood(3)) {
				StepDone<OnlineThreeMonthsTurnover>()
					.Init(Trail.MyInputData.OnlineTurnover3M, Trail.MyInputData.OnlineTurnover1Y, Trail.MyInputData.Configuration.OnlineTurnoverDropQuarterRatio);
			} else {
		...
		private void HmrcTurnovers() {
			if (!Trail.MyInputData.HasHmrc && Trail.MyInputData.HasOnline) {
				StepDone<HmrcTurnoverAge>()
					.Init(Trail.MyInputData.HasHmrc);
				return;
			} // if

			if (Trail.MyInputData.IsHmrcTurnoverTooOld()) {
				StepFailed<HmrcTurnoverAge>()
					.Init(Trail.MyInputData.HmrcUpdateTime, Trail.MyInputData.DataAsOf);
			} else {
				StepDone<HmrcTurnoverAge>()
					.Init(Trail.MyInputData.HmrcUpdateTime, Trail.MyInputData.DataAsOf);
			}
			...
			if (Trail.MyInputData.IsHmrcTurnoverGood(3)) {
				StepDone<HmrcThreeMonthsTurnover>()
					.Init(Trail.MyInputData.HmrcTurnover3M, Trail.MyInputData.HmrcTurnover1Y, Trail.MyInputData.Configuration.HmrcTurnoverDropQuarterRatio);
			} else {
			...
			if (Trail.MyInputData.IsHmrcTurnoverGood(6)) {
				StepDone<HalfYearTurnover>()
					.Init(Trail.MyInputData.HmrcTurnover6M, Trail.MyInputData.HmrcTurnover1Y, Trail.MyInputData.Configuration.HmrcTurnoverDropHalfYearRatio);
			} else {
