namespace AutomationCalculator.MedalCalculation {
	...
	public class MedalChooser {
		...
		/// rules are:
		/// a.	If customer has HMRC or bank that was last updated over 180 days ago (Config name = MedalDaysOfMpRelevancy) – No medal
		...
		/// i.		If customer has ebay or amazon or paypal   use "Online Non-Limited With Business Score Medal calculation logic"
		/// ii.		Else  use "Non-Limited Medal calculation logic"
		/// e.	Else if customer has ebay or amazon or paypal   use "Online Non-Limited No Business Score Medal calculation logic"
