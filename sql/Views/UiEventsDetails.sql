...
CREATE VIEW UiEventsDetails AS
SELECT e.UserID, a.UiActionName, c.UiControlName, e.EventTime, e.ControlHtmlID, e.EventArguments, e.RemoteIP, b.BrowserVersion FROM UiEvents e 
