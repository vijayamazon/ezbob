...
BEGIN
	...
	SELECT @tmp1 = CONVERT(NVARCHAR, DATEADD(month, - qoc.CompanySeniorityMonths - 6, GETUTCDATE()), 112)
	FROM
	...
	UPDATE Company SET ExperianRefNum = @CompanyRefNum WHERE CustomerId = @CustomerID
END
GO
