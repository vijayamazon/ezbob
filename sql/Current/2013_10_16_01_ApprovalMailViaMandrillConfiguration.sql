...
ELSE
BEGIN
	INSERT INTO MandrillTemplate VALUES ('Mandrill - Approval (1st time)')
	SELECT @TemplateId = Id FROM MandrillTemplate WHERE NAME = 'Mandrill - Approval (1st time)'
END
...
ELSE
BEGIN
	INSERT INTO MandrillTemplate VALUES ('Mandrill - Approval (not 1st time)')
	SELECT @TemplateId = Id FROM MandrillTemplate WHERE NAME = 'Mandrill - Approval (not 1st time)'
END
...
BEGIN
	INSERT INTO MailTemplateRelation VALUES ('Congratulations you are qualified - not first.docx', @TemplateId)
END
GO
