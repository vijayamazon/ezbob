IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DeleteCustomer]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Export_GetExportFile]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[Export_GetExportFile]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Export_GetNodeTemplateLinks]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[Export_GetNodeTemplateLinks]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Export_GetResultsByNodeName]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Export_GetTemplateLinks]') AND TYPE IN (N'P', N'PC'))
