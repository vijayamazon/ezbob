IF NOT EXISTS (SELECT * FROM UiControlGroups WHERE UiControlGroupID = 3)
BEGIN
	INSERT INTO UiControlGroups(UiControlGroupID, UiControlGroupName) VALUES (3, 'Link Accounts')

	INSERT INTO UiControlGroupRelevance(UiControlGroupID, UiControlID)
	SELECT 3, UiControlID FROM UiControls WHERE UiControlName LIKE 'link-account:%' OR UiControlName LIKE 'ekm%'
END
GO
