...
DECLARE @CapOfferByCustomerScores NVARCHAR(64) = 'CapOfferByCustomerScoresHomeless'
...
BEGIN
	...
	INSERT INTO MatrixColumns (MatrixRowID, TitleValue, CellValue) VALUES (@RowID,  500, 0.50)
	INSERT INTO MatrixColumns (MatrixRowID, TitleValue, CellValue) VALUES (@RowID,  650, 0.65)
	INSERT INTO MatrixColumns (MatrixRowID, TitleValue, CellValue) VALUES (@RowID,  999, 1.00)
