...
BEGIN 
INSERT INTO dbo.ConfigurationVariables(Name, Value, Description, IsEncrypted)
	VALUES('SmsApprovedUserTemplate', '*FirstName*, you are approved for *LoanAmount* for *ValidFor* hours interest of *InterestRate*, sf *SetupFee* by *Origin*', 'supports following tags: *FirstName*, *LoanAmount*, *ValidFor*, *InterestRate*, *SetupFee*, *Origin*', NULL)
END 	
GO
