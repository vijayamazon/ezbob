...
[
	...
	{
		"Name": "Limited Company Commercial Delphi Credit Text ",

		"PathToParent": "./REQUEST/DL79",

		"MetaData": { "UnlimitedWidth": true },

		"Fields": [
			{ "SourcePath": "./CREDITTEXT1", "Targets": [{ "Name": "Commercial Delphi Credit Text"}] }
		]
	},
	{
				...
				"Targets": [
					{ "Name": "Account Type" },
					{
						...
						"Transformation": {
							"Types": [ "map" ],
							"Map": {
								"01": "Hire purchase (including lease purchase)",
								"02": "Loan",
								"03": "Mortgage (including second mortgage)",
								"04": "Budget Account/Revolving Account",
								"05": "Credit Card / Store Card",
								"06": "Charge card",
								"07": "Rental ",
								"08": "Mail Order",
								"15": "Current accounts",
