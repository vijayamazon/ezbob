...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Insert_Security_Role]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UpdateRole]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[UpdateRole]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LockBegin]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[LockBegin]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LockCheckStatus]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GeAnnualSalesAmazon]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[MP_GeAnnualSalesAmazon]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GeAnnualSalesEBay]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[MP_GeAnnualSalesEBay]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GetAllCustomerMPUMI]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GetAmazonOrdersNumber]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GetEbayFeedback]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GetInventoryCashValue]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[MP_GetInventoryCashValue]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GetEbayOrdersTotalSum]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[MP_GetEbayOrdersTotalSum]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GetInventoryItemsCount]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[MP_GetInventoryItemsCount]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GetScoreCardData]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PAGING_CURSOR_COUNT]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Security_GetSession]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[Security_GetSession]
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Security_GetUserById]') AND TYPE IN (N'P', N'PC'))
...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Security_GrandServiceAction]') AND TYPE IN (N'P', N'PC'))
