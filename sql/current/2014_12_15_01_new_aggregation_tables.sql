...
BEGIN
	CREATE TABLE AmazonAggregation (
		...
		OrdersCancellationRateDenominator NUMERIC(18, 2) NOT NULL,
		OrdersCancellationRateNumerator NUMERIC(18, 2) NOT NULL,
...
BEGIN
	CREATE TABLE EkmAggregation (
		...
		CancellationRateDenominator NUMERIC(18, 2) NOT NULL,
		CancellationRateNumerator NUMERIC(18, 2) NOT NULL,
...
BEGIN
	CREATE TABLE PayPalAggregation (
		...
		RatioNetSumOfRefundsAndReturnsToNetRevenuesDenominator NUMERIC(18, 2) NOT NULL,
		RatioNetSumOfRefundsAndReturnsToNetRevenuesNumerator NUMERIC(18, 2) NOT NULL,
