IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetPerformencePerUnderwriterReport]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[GetPerformencePerUnderwriterReport]
GO
SET ANSI_NULLS ON
GO
