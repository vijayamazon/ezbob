IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UwGridAll]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[UwGridAll]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[UwGridAll] 
	(@WithTest BIT)
AS
BEGIN
	SELECT
