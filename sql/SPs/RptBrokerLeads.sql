IF object_ID('RptBrokerLeads') IS NULL
BEGIN
	EXECUTE('CREATE PROCEDURE RptBrokerLeads AS SELECT 1')
END
GO
...
ALTER PROCEDURE RptBrokerLeads
@DateStart DATETIME,
@DateEnd DATETIME
AS
BEGIN
...
(
                ...
                WHERE
                                ...
                                AND B.FirmName NOT IN ('Confero','Everline VIP Campaign')
