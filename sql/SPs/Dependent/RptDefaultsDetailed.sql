...
BEGIN
	...
	BEGIN
		...
		FROM
			...
			INNER JOIN Customer c
				...
				AND c.IsTest = 0
		WHERE
			ABS(lst.PrincipalDelta) + ABS(lst.FeesDelta) + ABS(lst.InterestDelta) > @Threshold
			AND
			lst.LoanID = @LoanId
			AND
			lst.[Date] < @CutoffDate
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN                                                  
					...
					BEGIN
						SELECT
							@LastTransactionDate = LoanTransaction.PostDate
						FROM
							LoanTransaction
						WHERE
						...
						SELECT
							@StatusAfterLastTransaction = StatusAfter
						FROM
							LoanScheduleTransaction
						WHERE
							ScheduleID = @ScheduleId
					...
					SELECT
						@StatusAfterLastTransactionFromLoanSchedule = Status
					FROM
						LoanSchedule
					WHERE
						Id = @ScheduleId
					...
					IF
						...
						AND @StatusAfterLastTransaction = 'Paid' OR @StatusAfterLastTransaction = 'PaidOnTime' OR @StatusAfterLastTransaction = 'PaidEarly' AND (
					...
					INSERT INTO #SpecialLate VALUES (
						@CustomerId, @CustomerStatus, @LoanId, @Pct, @ScheduleDate,
					...
					SELECT
						...
						@LoanAmount = NULL,
						@LoanDate = NULL,
						@StatusAfterLastTransaction = NULL                                                              
				END
			END
	...
	SELECT
		@NumOfSpecialLateLoans = Count(1),
		@SumOfSpecialLateLoans = SUM(LoanAmount),
		@OutstandingSpecialLatePrincipal = SUM(Principal)
	FROM
		#SpecialLate

	SELECT
		@NumOfSpecialLate1_14Loans = Count(1),
		@SumOfSpecialLate1_14Loans = SUM(LoanAmount),
		@OutstandingSpecialLate1_14Principal = SUM(Principal)
	FROM
		#SpecialLate
	WHERE
		LateDays >= 1
	...
	SELECT
		@NumOfSpecialLate15_30Loans = Count(1),
		@SumOfSpecialLate15_30Loans = SUM(LoanAmount),
		@OutstandingSpecialLate15_30Principal = SUM(Principal)
	FROM
		#SpecialLate
	WHERE
		LateDays >= 15
	...
	SELECT
		@NumOfSpecialLate31_45Loans = Count(1),
		@SumOfSpecialLate31_45Loans = SUM(LoanAmount),
		@OutstandingSpecialLate31_45Principal = SUM(Principal)
	FROM
		#SpecialLate
	WHERE
		LateDays >= 31
	...
	SELECT
		@NumOfSpecialLate46_60Loans = Count(1),
		@SumOfSpecialLate46_60Loans = SUM(LoanAmount),
		@OutstandingSpecialLate46_60Principal = SUM(Principal)
	FROM
		#SpecialLate
	WHERE
		LateDays >= 46
	...
	SELECT
		@NumOfSpecialLateOver60Loans = Count(1),
		@SumOfSpecialLateOver60Loans = SUM(LoanAmount),
		@OutstandingSpecialLateOver60Principal = SUM(Principal)
	FROM
		#SpecialLate
	WHERE
		LateDays > 60
	...
	SELECT
		...
		@SumOfLoans AS SumOfLoans,
		@OutstandingPrincipal AS OutstandingPrincipal,
		@NumOfSpecialLateLoans AS NumOfSpecialLateLoans,
		@SumOfSpecialLateLoans AS SumOfSpecialLateLoans,
		@OutstandingSpecialLatePrincipal AS OutstandingSpecialLatePrincipal,
		@NumOfSpecialLate1_14Loans AS NumOfSpecialLate1_14Loans,
		@SumOfSpecialLate1_14Loans AS SumOfSpecialLate1_14Loans,
		@OutstandingSpecialLate1_14Principal AS OutstandingSpecialLate1_14Principal,
		@NumOfSpecialLate15_30Loans AS NumOfSpecialLate15_30Loans,
		@SumOfSpecialLate15_30Loans AS SumOfSpecialLate15_30Loans,
		@OutstandingSpecialLate15_30Principal AS OutstandingSpecialLate15_30Principal,
		@NumOfSpecialLate31_45Loans AS NumOfSpecialLate31_45Loans,
		@SumOfSpecialLate31_45Loans AS SumOfSpecialLate31_45Loans,
		@OutstandingSpecialLate31_45Principal AS OutstandingSpecialLate31_45Principal,
		@NumOfSpecialLate46_60Loans AS NumOfSpecialLate46_60Loans,
		@SumOfSpecialLate46_60Loans AS SumOfSpecialLate46_60Loans,
		@OutstandingSpecialLate46_60Principal AS OutstandingSpecialLate46_60Principal,
		@NumOfSpecialLateOver60Loans AS NumOfSpecialLateOver60Loans,
		@SumOfSpecialLateOver60Loans AS SumOfSpecialLateOver60Loans,
		@OutstandingSpecialLateOver60Principal AS OutstandingSpecialLateOver60Principal
	...
	SELECT
		T2.CustomerId,
		T2.CustomerStatus,
		T2.IsOffline AS OfflineOrOnline,
		T2.BrokerOrNot AS IsBrokerClient,
		T2.Loan_Type AS IsEuLoan,
		T2.LoanId,
		T2.LoanDate,
