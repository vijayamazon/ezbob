...
BEGIN 
UPDATE MedalCalculationsAV SET IsActive = 0 WHERE IsActive = 1 AND CustomerId = @CustomerId
INSERT INTO MedalCalculationsAV (CustomerId,IsActive,CalculationTime,MedalType,Medal,Error,NumOfHmrcMps) 
VALUES                          (@CustomerId,1,@CalculationTime,@MedalType,@Medal,@Error,@NumOfHmrcMps)
END 
GO
