...
IF OBJECT_ID('GetActivePayPalAggregationsByMpHistory') IS NULL
	EXECUTE('CREATE PROCEDURE GetActivePayPalAggregationsByMpHistory AS SELECT 1')
GO

ALTER PROCEDURE GetActivePayPalAggregationsByMpHistory
