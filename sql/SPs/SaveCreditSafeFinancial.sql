...
CREATE TYPE CreditSafeFinancialList AS TABLE (
	...
	PreTaxMargin NVARCHAR(20) NULL,
	CurrentRatio NVARCHAR(20) NULL,
	NetworkingCapital NVARCHAR(20) NULL,
	GearingRatio NVARCHAR(20) NULL,
	Equity NVARCHAR(20) NULL,
	CreditorDays NVARCHAR(20) NULL,
	DebtorDays NVARCHAR(20) NULL,
	Liquidity NVARCHAR(20) NULL,
	ReturnOnCapitalEmployed NVARCHAR(20) NULL,
	ReturnOnAssetsEmployed NVARCHAR(20) NULL,
	CurrentDebtRatio NVARCHAR(20) NULL,
	TotalDebtRatio NVARCHAR(20) NULL,
	StockTurnoverRatio NVARCHAR(20) NULL,
	ReturnOnNetAssetsEmployed NVARCHAR(20) NULL
)
GO
