IF EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AV_ReApprovalData]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[AV_ReApprovalData]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AV_ReApprovalData] 
	(@CustomerId INT,
@CashRequestId INT)
AS
BEGIN
