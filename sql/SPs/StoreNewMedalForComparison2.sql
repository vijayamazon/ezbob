IF OBJECT_ID('StoreNewMedalForComparison2') IS NULL
	EXECUTE('CREATE PROCEDURE StoreNewMedalForComparison2 AS SELECT 1')
GO

ALTER PROCEDURE StoreNewMedalForComparison2
	(@CustomerId INT
