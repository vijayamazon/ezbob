IF  NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[RptLoanStats_CashRequests]') AND type in (N'P', N'PC'))
	EXECUTE ('CREATE PROCEDURE [dbo].[RptLoanStats_CashRequests] AS SELECT 1')
GO
