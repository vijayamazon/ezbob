IF NOT EXISTS (SELECT * FROM BrokerTerms WHERE OriginID = 1 AND DateAdded = '5 July 2015')
BEGIN
	...
	'<h2 align=center style="text-align:center"><font face="Titillium Web Semi Bold"><strong>Broker and Intermediary Terms and Conditions</strong></font></h2>
	<font face="open sans">
	<p>The following terms and conditions govern Your relationship with Orange Money Ltd. (trading as EZBob) and participation in Our broker and intermediary program
	...
	&quot;We&quot;, &quot;Us&quot; and &quot;Our&quot;, means, Orange Money Ltd. References to &quot;You&quot; and &quot;Your&quot; means the person identified
	...
	<p>Orange Money Ltd. is authorized and regulated by the Financial Control Authority. Our
	...
	<p>You acknowledge and agree that You are not an agent of Orange Money Ltd. and will not hold yourself out to be Our agent. You acknowledge that You may not make any representations or give any warranty on behalf of Us nor have the
	...
	referencing the name Orange Money Ltd. or EZBob (or any variation thereof)
	...
	affiliate or related party of Orange Money Ltd.</p>
	...
	Materials or otherwise reference Orange Money or EZBob (or any variation thereof) on any website or other publication that contains or has links to or
	...
	<ol start=1 type=1 style="margin-left:40px">
	 ...
	 <li>Resembles Our
		 ...
		 subsidiary or affiliate of Orange Money Ltd.</li>
	</ol>

	<p><li> You must not engage in the
	distribution of any unsolicited bulk emails (spam) in any way mentioning or
	referencing Orange Money or EZBob (or any variation thereof) or containing any
