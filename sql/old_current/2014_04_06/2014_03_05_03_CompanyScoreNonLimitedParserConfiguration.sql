UPDATE ConfigurationVariables SET Value = '[
	...
	},
	{
		...
		"Fields": [
			{ "SourcePath": "./PREVSEARCH-YYYY", "Targets": [{ "Name": "Previous search date", "Position": 2, "Prefix": " " }] },
			{ "SourcePath": "./PREVSEARCH-MM", "Targets": [{ "Name": "Previous search date", "Position": 0, "Transformation": { "Types": [ "monthname" ] } }] },
			{ "SourcePath": "./PREVSEARCH-DD", "Targets": [{ "Name": "Previous search date", "Position": 1, "Prefix": " " }] },
