namespace Ezbob.Backend.CalculateLoan.Models {
	...
	public class OneDayState {
		...
		/// </summary>
		public decimal OpenPrincipalForInterest { get; private set; }

		/// <summary>
		/// This open principal customer has at the end (i.e. 23:59:59) of the day.
		/// </summary>
		public decimal OpenPrincipalAfterRepayments { get; private set; }
		...
		public class FormattedData {
			internal FormattedData(OneDayState odls) { this.odls = odls; }
			...
			private readonly OneDayState odls;
		} // class FormattedData
		...
		private readonly OneDayState previousDay;
