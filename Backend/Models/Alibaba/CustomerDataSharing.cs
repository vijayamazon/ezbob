...
78		LLP
    ...
    public class CustomerDataSharing {
        ...
        private DateTime? _compEstablished;
        private DateTime? _applicationDate;
        private DateTime? _locOfferDate;
        public DateTime? _locOfferExpireDate;
        private DateTime? _locApproveDate;
        private DateTime? _locExpireDate;
        ...
        public DateTime? compEstablished {
            get { return this._compEstablished; }
            set { this._compEstablished = FormatDate(value);  }
        }
        ...
        */
        ...
        public DateTime? applicationDate {
            get { return this._applicationDate; }
            set { this._applicationDate = FormatDate(value); }
        }
        /*
         * 
        ...
        public DateTime? locOfferDate {
            get { return this._locOfferDate; }
            set { this._locOfferDate = FormatDate(value); }
        }

        [DataMember(EmitDefaultValue = false)] //Expiration date for the Line of Credit; yyyy-MM-dd hh:mm:ssUS PT | N
        public DateTime? locOfferExpireDate {
            get { return this._locOfferExpireDate; }
            set { this._locOfferExpireDate = FormatDate(value); }
        }
        ...
        public DateTime? locApproveDate {
            get { return this._locApproveDate; }
            set { this._locApproveDate = FormatDate(value);  }
        }

        [DataMember(EmitDefaultValue = false)] // Credit line valid until; yyyy-MM-dd hh:mm:ssUS PT |N
        public DateTime? locExpireDate {
            get {return this._locExpireDate;}
            set { this._locExpireDate = FormatDate(value); }
        }
        ...
        private DateTime? FormatDate(DateTime? dateUnformated) {
            if (dateUnformated == null) {
                return null;
            }
            DateTime date = (DateTime)dateUnformated;
