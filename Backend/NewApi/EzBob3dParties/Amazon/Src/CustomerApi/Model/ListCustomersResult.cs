...
namespace EzBob3dParties.Amazon.Src.CustomerApi.Model
{
    ...
    public class ListCustomersResult : AbstractMwsObject
    {
        ...
        public ListCustomersResult WithCustomerList(Customer[] customerList)
        {
        ...
        /// <returns>this instance.</returns>
        public ListCustomersResult WithNextToken(string nextToken)
        {
        ...
        /// <returns>this instance.</returns>
        public ListCustomersResult WithMoreResultsAvailable(bool moreResultsAvailable)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/CustomerInformation/2014-03-01", "ListCustomersResult", this);
        }

        public ListCustomersResult() : base()
        {
        }
    }
}
