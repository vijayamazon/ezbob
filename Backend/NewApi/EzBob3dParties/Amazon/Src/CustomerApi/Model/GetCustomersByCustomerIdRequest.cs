 ...
 *******************************************************************************
 * Get Customers By Customer Id Request
...
namespace EzBob3dParties.Amazon.Src.CustomerApi.Model
{
    ...
    public class GetCustomersByCustomerIdRequest : AbstractMwsObject
    {
        ...
        public GetCustomersByCustomerIdRequest WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public GetCustomersByCustomerIdRequest WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        /// <returns>this instance.</returns>
        public GetCustomersByCustomerIdRequest WithMarketplaceId(string marketplaceId)
        {
        ...
        /// <returns>this instance.</returns>
        public GetCustomersByCustomerIdRequest WithCustomerIdList(string[] customerIdList)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/CustomerInformation/2014-03-01", "GetCustomersByCustomerIdRequest", this);
        }

        public GetCustomersByCustomerIdRequest() : base()
        {
        }
    }
}
