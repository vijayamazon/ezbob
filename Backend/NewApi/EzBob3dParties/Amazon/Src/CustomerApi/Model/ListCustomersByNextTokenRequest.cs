 ...
 *******************************************************************************
 * List Customers By Next Token Request
...
namespace EzBob3dParties.Amazon.Src.CustomerApi.Model
{
    ...
    public class ListCustomersByNextTokenRequest : AbstractMwsObject
    {
        ...
        public ListCustomersByNextTokenRequest WithSellerId(string sellerId)
        {
        ...
        /// <returns>this instance.</returns>
        public ListCustomersByNextTokenRequest WithMWSAuthToken(string mwsAuthToken)
        {
        ...
        /// <returns>this instance.</returns>
        public ListCustomersByNextTokenRequest WithNextToken(string nextToken)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/CustomerInformation/2014-03-01", "ListCustomersByNextTokenRequest", this);
        }

        public ListCustomersByNextTokenRequest() : base()
        {
        }
    }
}
