 ...
 *******************************************************************************
 * Get Customers For Customer Id Result
...
namespace EzBob3dParties.Amazon.Src.CustomerApi.Model
{
    ...
    public class GetCustomersForCustomerIdResult : AbstractMwsObject
    {
        ...
        public GetCustomersForCustomerIdResult WithCustomerList(Customer[] customerList)
        {
        ...
        {
            writer.Write("http://mws.amazonservices.com/schema/CustomerInformation/2014-03-01", "GetCustomersForCustomerIdResult", this);
        }

        public GetCustomersForCustomerIdResult() : base()
        {
        }
    }
}
