...
namespace EzBob3dParties.Amazon.Src.CustomerApi
{
    ...
    /// </summary>
    public class MWSCustomerServiceConfig {

        private const string DEFAULT_SERVICE_PATH = "CustomerInformation/2014-03-01";
        private const string SERVICE_VERSION = "2014-03-01";
        ...
        public MWSCustomerServiceConfig WithSignatureMethod(string signatureMethod)
        {
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithSignatureVersion(string signatureVersion)
        {
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithUserAgent(String userAgent)
        {
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithUserAgent(string applicationName, string applicationVersion)
        {
        ...
        /// May include the path to make MWS calls to. Defaults to CustomerInformation/2014-03-01
        /// </summary>
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithServiceURL(string serviceURL)
        {
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithProxyHost(string proxyHost)
        {
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithProxyPort(int proxyPort)
        {
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithProxyUsername(string proxyUsername)
        {
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithProxyPassword(string proxyPassword)
        {
        ...
        /// <returns>this instance</returns>
        public MWSCustomerServiceConfig WithMaxErrorRetry(int maxErrorRetry)
        {
        ...
        public MWSCustomerServiceConfig WithRequestHeader(string name, string value)
        {
            this.cc.IncludeRequestHeader(name, value);
            return this;
        }
