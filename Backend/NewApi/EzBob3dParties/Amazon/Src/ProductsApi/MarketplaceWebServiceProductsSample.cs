...
namespace EzBob3dParties.Amazon.Src.ProductsApi {
    ...
    public class MarketplaceWebServiceProductsSample {
        ...
        public static void Main(string[] args)
        {
            ...
            IMwsProductsService client = new ImwsProductsServiceClient(appName, appVersion, accessKey, secretKey, config);
        ...
        private readonly IMwsProductsService client;

        public MarketplaceWebServiceProductsSample(IMwsProductsService client)
        {
            this.client = client;
        }
        ...
        public GetProductCategoriesForSKUResponse InvokeGetProductCategoriesForSKU()
        {
            ...
            string sellerSKU = "example";
            request.SellerSKU = sellerSKU;
            return this.client.GetProductCategoriesForSKU(request).Result;
        }
