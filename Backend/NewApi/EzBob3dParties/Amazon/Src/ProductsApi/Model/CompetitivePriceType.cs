...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class CompetitivePriceType : AbstractMwsObject
    {
        ...
        public override void ReadFragmentFrom(IMwsReader reader)
        {
            ...
            this._subcondition = reader.ReadAttribute<string>("subcondition");
            this._belongsToRequester = reader.ReadAttribute<bool?>("belongsToRequester");
            this._competitivePriceId = reader.Read<string>("CompetitivePriceId");
        ...
        public override void WriteFragmentTo(IMwsWriter writer)
        {
            ...
            writer.WriteAttribute("subcondition",this._subcondition);
            writer.WriteAttribute("belongsToRequester",this._belongsToRequester);
            writer.Write("CompetitivePriceId", this._competitivePriceId);
            writer.Write("Price", this._price);
        }
