...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class ListMatchingProductsResponse : AbstractMwsObject, IMWSResponse
    {
        ...
        {
            this._listMatchingProductsResult = reader.Read<ListMatchingProductsResult>("ListMatchingProductsResult");
            this._responseMetadata = reader.Read<ResponseMetadata>("ResponseMetadata");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.Write("ListMatchingProductsResult", this._listMatchingProductsResult);
