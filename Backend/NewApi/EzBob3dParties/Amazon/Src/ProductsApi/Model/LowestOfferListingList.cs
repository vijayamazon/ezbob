...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class LowestOfferListingList : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElement(ElementName = "LowestOfferListing")]
        ...
        {
            this._lowestOfferListing = reader.ReadList<LowestOfferListingType>("LowestOfferListing");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.WriteList("LowestOfferListing", this._lowestOfferListing);
        }
