...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class GetLowestPricedOffersForASINResponse : AbstractMwsObject, IMWSResponse
    {
        ...
        /// </summary>
        [XmlElement(ElementName = "GetLowestPricedOffersForASINResult")]
        ...
        {
            this._getLowestPricedOffersForASINResult = reader.Read<GetLowestPricedOffersForASINResult>("GetLowestPricedOffersForASINResult");
            this._responseMetadata = reader.Read<ResponseMetadata>("ResponseMetadata");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.Write("GetLowestPricedOffersForASINResult", this._getLowestPricedOffersForASINResult);
