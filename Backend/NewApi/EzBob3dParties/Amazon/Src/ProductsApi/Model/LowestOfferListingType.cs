...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class LowestOfferListingType : AbstractMwsObject
    {
        ...
        {
            writer.Write("Qualifiers", this._qualifiers);
            writer.Write("NumberOfOfferListingsConsidered", this._numberOfOfferListingsConsidered);
            writer.Write("SellerFeedbackCount", this._sellerFeedbackCount);
            writer.Write("Price", this._price);
            writer.Write("MultipleOffersAtLowestPrice", this._multipleOffersAtLowestPrice);
        }
