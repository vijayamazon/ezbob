...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class GetProductCategoriesForASINResponse : AbstractMwsObject, IMWSResponse
    {
        ...
        {
            this._getProductCategoriesForASINResult = reader.Read<GetProductCategoriesForASINResult>("GetProductCategoriesForASINResult");
            this._responseMetadata = reader.Read<ResponseMetadata>("ResponseMetadata");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.Write("GetProductCategoriesForASINResult", this._getProductCategoriesForASINResult);
