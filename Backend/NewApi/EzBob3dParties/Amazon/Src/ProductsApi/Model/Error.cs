...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class Error : AbstractMwsObject
    {
        ...
        {
            this._type = reader.Read<string>("Type");
            this._code = reader.Read<string>("Code");
            this._message = reader.Read<string>("Message");
            this._detail = reader.Read<ErrorDetail>("Detail");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.Write("Type", this._type);
            writer.Write("Code", this._code);
            writer.Write("Message", this._message);
            writer.Write("Detail", this._detail);
        }
