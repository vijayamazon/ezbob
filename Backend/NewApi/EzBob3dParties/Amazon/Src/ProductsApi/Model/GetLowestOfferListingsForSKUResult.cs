...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class GetLowestOfferListingsForSKUResult : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElement(ElementName = "AllOfferListingsConsidered")]
        ...
        {
            this._sellerSKU = reader.ReadAttribute<string>("SellerSKU");
            this._status = reader.ReadAttribute<string>("status");
            this._allOfferListingsConsidered = reader.Read<bool?>("AllOfferListingsConsidered");
        ...
        {
            writer.WriteAttribute("SellerSKU",this._sellerSKU);
            writer.WriteAttribute("status",this._status);
            writer.Write("AllOfferListingsConsidered", this._allOfferListingsConsidered);
