...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class GetMyPriceForASINResponse : AbstractMwsObject, IMWSResponse
    {
        ...
        /// </summary>
        [XmlElement(ElementName = "GetMyPriceForASINResult")]
        ...
        {
            this._getMyPriceForASINResult = reader.ReadList<GetMyPriceForASINResult>("GetMyPriceForASINResult");
            this._responseMetadata = reader.Read<ResponseMetadata>("ResponseMetadata");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.WriteList("GetMyPriceForASINResult", this._getMyPriceForASINResult);
