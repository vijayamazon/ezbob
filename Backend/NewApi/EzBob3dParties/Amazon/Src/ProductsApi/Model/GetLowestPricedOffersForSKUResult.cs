...
namespace EzBob3dParties.Amazon.Src.ProductsApi.Model
{
    ...
    public class GetLowestPricedOffersForSKUResult : AbstractMwsObject
    {
        ...
        public override void ReadFragmentFrom(IMwsReader reader)
        {
            ...
            this._sku = reader.ReadAttribute<string>("SKU");
            this._itemCondition = reader.ReadAttribute<string>("ItemCondition");
            this._status = reader.ReadAttribute<string>("status");
            this._identifier = reader.Read<GetLowestPricedOffersSkuIdentifier>("Identifier");
            this._summary = reader.Read<Summary>("Summary");
            this._offers = reader.Read<SKUOfferDetailList>("Offers");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.WriteAttribute("MarketplaceID",this._marketplaceID);
            writer.WriteAttribute("SKU",this._sku);
            writer.WriteAttribute("ItemCondition",this._itemCondition);
            writer.WriteAttribute("status",this._status);
            writer.Write("Identifier", this._identifier);
            writer.Write("Summary", this._summary);
