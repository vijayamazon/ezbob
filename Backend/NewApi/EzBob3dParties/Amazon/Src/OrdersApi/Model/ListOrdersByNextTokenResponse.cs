...
namespace EzBob3dParties.Amazon.Src.OrdersApi.Model
{
    ...
    public class ListOrdersByNextTokenResponse : AbstractMwsObject, IMWSResponse
    {
        ...
        {
            this._listOrdersByNextTokenResult = reader.Read<ListOrdersByNextTokenResult>("ListOrdersByNextTokenResult");
            this._responseMetadata = reader.Read<ResponseMetadata>("ResponseMetadata");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.Write("ListOrdersByNextTokenResult", this._listOrdersByNextTokenResult);
