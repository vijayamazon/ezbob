...
namespace EzBob3dParties.Amazon.Src.OrdersApi.Model
{
    ...
    public class InvoiceData : AbstractMwsObject
    {
        ...
        {
            this._invoiceRequirement = reader.Read<string>("InvoiceRequirement");
            this._buyerSelectedInvoiceCategory = reader.Read<string>("BuyerSelectedInvoiceCategory");
            this._invoiceTitle = reader.Read<string>("InvoiceTitle");
            this._invoiceInformation = reader.Read<string>("InvoiceInformation");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.Write("InvoiceRequirement", this._invoiceRequirement);
            writer.Write("BuyerSelectedInvoiceCategory", this._buyerSelectedInvoiceCategory);
            writer.Write("InvoiceTitle", this._invoiceTitle);
            writer.Write("InvoiceInformation", this._invoiceInformation);
        }
