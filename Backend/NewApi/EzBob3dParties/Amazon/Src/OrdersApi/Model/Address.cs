...
namespace EzBob3dParties.Amazon.Src.OrdersApi.Model
{
    ...
    public class Address : AbstractMwsObject
    {
        ...
        public override void ReadFragmentFrom(IMwsReader reader)
        {
            ...
            this._addressLine3 = reader.Read<string>("AddressLine3");
            this._city = reader.Read<string>("City");
            this._county = reader.Read<string>("County");
            this._district = reader.Read<string>("District");
            ...
            this._phone = reader.Read<string>("Phone");
        }
        ...
        public override void WriteFragmentTo(IMwsWriter writer)
        {
            ...
            writer.Write("AddressLine3", this._addressLine3);
            writer.Write("City", this._city);
            writer.Write("County", this._county);
            writer.Write("District", this._district);
            ...
            writer.Write("Phone", this._phone);
        }
