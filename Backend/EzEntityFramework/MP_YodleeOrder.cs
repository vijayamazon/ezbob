...
namespace EzEntityFramework
{
    ...
    public partial class MP_YodleeOrder
    {
        public MP_YodleeOrder()
        {
            this.MP_YodleeOrderItem = new HashSet<MP_YodleeOrderItem>();
        }
        ...
        public virtual ICollection<MP_YodleeOrderItem> MP_YodleeOrderItem { get; set; }
    }
}
