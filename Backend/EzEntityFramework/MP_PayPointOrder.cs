...
namespace EzEntityFramework
{
    ...
    public partial class MP_PayPointOrder
    {
        public MP_PayPointOrder()
        {
            this.MP_PayPointOrderItem = new HashSet<MP_PayPointOrderItem>();
        }
        ...
        public virtual ICollection<MP_PayPointOrderItem> MP_PayPointOrderItem { get; set; }
    }
}
