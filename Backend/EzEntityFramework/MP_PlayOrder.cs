...
namespace EzEntityFramework
{
    ...
    public partial class MP_PlayOrder
    {
        public MP_PlayOrder()
        {
            this.MP_PlayOrderItem = new HashSet<MP_PlayOrderItem>();
        }
        ...
        public virtual ICollection<MP_PlayOrderItem> MP_PlayOrderItem { get; set; }
    }
}
