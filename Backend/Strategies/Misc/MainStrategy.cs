namespace EzBob.Backend.Strategies.Misc
{
	...
	public class MainStrategy : AStrategy
	{
		...
		private readonly NewMedalScoreCalculator2 offlineMedalCalculator2;
			...
			: base(oDb, oLog)
		{
			...
			offlineMedalCalculator2 = new NewMedalScoreCalculator2(oDb, oLog);
		...
		private void CalculateAndSaveOfflineMedal()
		{
			try
			{
				...
				ScoreResult result2 = offlineMedalCalculator2.CalculateMedalScore(customerId);

				if (CheckResultsForMatching(result, result2))
				{
