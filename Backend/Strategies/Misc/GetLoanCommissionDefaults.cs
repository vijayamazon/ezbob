namespace Ezbob.Backend.Strategies.Misc {
	...
	public class GetLoanCommissionDefaults : AStrategy {
		...
		public override void Execute() {
			...
			if (sr.IsEmpty) {
				Result = new BrokerCommissionDefaultCalculator.Result(0, 0);
			...
			Result = new BrokerCommissionDefaultCalculator.Result(sr["BrokerSetupFeePercent"], sr["ManualSetupFeePercent"]);
			...
			Result = new BrokerCommissionDefaultCalculator().Calculate(this.loanAmount, firstLoanDate);
		...
		public BrokerCommissionDefaultCalculator.Result Result { get; private set; }
