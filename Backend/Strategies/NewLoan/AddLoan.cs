namespace Ezbob.Backend.Strategies.NewLoan
{
    ...
    public class AddLoan : AStrategy
    {
        ...
        {
            NL_AddLog(LogType.Info, "Strategy Start", this.model, null, null, null);
            try
            {
                ...
                NL_AddLog(LogType.Info, "Strategy End", this.model, this.LoanID, null, null);
            }
            catch (Exception ex)
            {
                NL_AddLog(LogType.Error, "Strategy Faild", this.model, null, ex.ToString(), ex.StackTrace);
            }
        }//Execute
