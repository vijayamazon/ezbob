namespace Ezbob.Backend.Strategies.Broker {
	...
	public class BrokerCustomerWizardComplete : AStrategy {
		...
		public override void Execute() {
			...
			// Wait the timeout period before sending the under review email:
			// if there was an automatic decision don't send the under review email.

			Thread.Sleep(ConfigManager.CurrentValues.Instance.WizardAutomationTimeout * 1000);

			SafeReader sr = DB.GetFirst(
				"GetCustomerDetailsForStateCalculation",
