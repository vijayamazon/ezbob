namespace Ezbob.Backend.Strategies.Investor {
	...
	public class UpdateSchedulerData : AStrategy {
		public UpdateSchedulerData(int underwriterID, int investorID, decimal monthlyFundingCapital, int fundsTransferDate, string fundsTransferSchedule, string repaymentsTransferSchedule) {
