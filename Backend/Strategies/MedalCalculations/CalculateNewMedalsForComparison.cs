			...
			DB.ForEachRowSafe((sr, bRowsetStart) =>
				{
					try
					{
						...
						DB.ExecuteNonQuery("StoreNewMedalForComparison1", CommandSpecies.StoredProcedure,
										   ...
										   new QueryParameter("HmrcAnnualTurnover", result1.HmrcAnnualTurnover),
										   new QueryParameter("BankAnnualTurnover", result1.BankAnnualTurnover),
										   new QueryParameter("OnlineAnnualTurnover", result1.OnlineAnnualTurnover),
						...
						DB.ExecuteNonQuery("StoreNewMedalForComparison2", CommandSpecies.StoredProcedure,
										   ...
										   new QueryParameter("HmrcAnnualTurnover", result2.HmrcAnnualTurnover),
										   new QueryParameter("BankAnnualTurnover", result2.BankAnnualTurnover),
										   new QueryParameter("OnlineAnnualTurnover", result2.OnlineAnnualTurnover),
