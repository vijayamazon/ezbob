namespace EzBob.Backend.Strategies
{
	...
	public class SaveAgreement : AStrategy
	{
		...
		public SaveAgreement(int customerId, AgreementModel model, string refNumber, string name, string template, string path1, string path2, AConnection oDb, ASafeLog oLog)
			: base(oDb, oLog)
		{
			_name = name;
			_template = template;
		...
		public override void Execute()
		{
			try
			{
				var html = Render.StringToString(_template, _model);
