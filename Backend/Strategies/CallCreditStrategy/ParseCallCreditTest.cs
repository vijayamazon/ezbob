...
using EzBobIntegration.Web_References.Consumer;
	...
	public class ParseCallCreditTest : AStrategy {

		public ParseCallCreditTest(CT_SearchResult resdata, long nServiceLogID) {
		...
		public CallCredit Parse(CT_SearchResult oDoc) {
			if (oDoc == null)
				return null;

			Log.Info("Parsing CallCredit company data...");
			var builder = new CallCreditModelBuilder();
			return builder.Build(oDoc, 12, 12, DateTime.UtcNow, 1);
		} // Parse
