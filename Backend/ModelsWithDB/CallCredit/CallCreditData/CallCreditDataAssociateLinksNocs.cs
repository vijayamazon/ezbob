namespace Ezbob.Backend.ModelsWithDB.CallCredit.CallCreditData {
	...
	public class CallCreditDataAssociateLinksNocs {
		[PK]
		[NonTraversable]
		public long CallCreditDataAssociateLinksNocsID { get; set; }
		[FK("CallCreditDataAssociateLinks", "CallCreditDataAssociateLinksID")]
