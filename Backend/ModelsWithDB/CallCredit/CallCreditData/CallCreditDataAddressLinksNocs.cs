namespace Ezbob.Backend.ModelsWithDB.CallCredit.CallCreditData {
	...
	public class CallCreditDataAddressLinksNocs {
		[PK]
		[NonTraversable]
		public long CallCreditDataAddressLinksNocsID { get; set; }
		[FK("CallCreditDataAddressLinks", "CallCreditDataAddressLinksID")]
