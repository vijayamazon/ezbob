...
namespace StrategiesActivator.EzServiceReference {
    ...
    [System.SerializableAttribute()]
    public partial class BrokerSmsCountActionResult : StrategiesActivator.EzServiceReference.ActionResult {
    ...
    public interface IEzService {
        ...
        StrategiesActivator.EzServiceReference.BrokerSmsCountActionResult BrokerLoadSmsCount();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEzService/BrokerLoadSmsCount", ReplyAction="http://tempuri.org/IEzService/BrokerLoadSmsCountResponse")]
        System.Threading.Tasks.Task<StrategiesActivator.EzServiceReference.BrokerSmsCountActionResult> BrokerLoadSmsCountAsync();
    ...
    public partial class EzServiceClient : System.ServiceModel.ClientBase<StrategiesActivator.EzServiceReference.IEzService>, StrategiesActivator.EzServiceReference.IEzService {
        ...
        public StrategiesActivator.EzServiceReference.BrokerSmsCountActionResult BrokerLoadSmsCount() {
            return base.Channel.BrokerLoadSmsCount();
        }
        
        public System.Threading.Tasks.Task<StrategiesActivator.EzServiceReference.BrokerSmsCountActionResult> BrokerLoadSmsCountAsync() {
            return base.Channel.BrokerLoadSmsCountAsync();
        }
        ...
        public StrategiesActivator.EzServiceReference.ActionMetaData BrokerSignup(string FirmName, string FirmRegNum, string ContactName, string ContactEmail, string ContactMobile, string MobileCode, string ContactOtherPhone, decimal EstimatedMonthlyClientAmount, string Password, string Password2, string sFirmWebSiteUrl, int nEstimatedMonthlyApplicationCount) {
            return base.Channel.BrokerSignup(FirmName, FirmRegNum, ContactName, ContactEmail, ContactMobile, MobileCode, ContactOtherPhone, EstimatedMonthlyClientAmount, Password, Password2, sFirmWebSiteUrl, nEstimatedMonthlyApplicationCount);
        }
        
        public System.Threading.Tasks.Task<StrategiesActivator.EzServiceReference.ActionMetaData> BrokerSignupAsync(string FirmName, string FirmRegNum, string ContactName, string ContactEmail, string ContactMobile, string MobileCode, string ContactOtherPhone, decimal EstimatedMonthlyClientAmount, string Password, string Password2, string sFirmWebSiteUrl, int nEstimatedMonthlyApplicationCount) {
            return base.Channel.BrokerSignupAsync(FirmName, FirmRegNum, ContactName, ContactEmail, ContactMobile, MobileCode, ContactOtherPhone, EstimatedMonthlyClientAmount, Password, Password2, sFirmWebSiteUrl, nEstimatedMonthlyApplicationCount);
        }
