...
namespace ServiceClientProxy.EzServiceReference {
    ...
    public interface IEzService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEzService/SendPendingMail", ReplyAction="http://tempuri.org/IEzService/SendPendingMailResponse")]
        ServiceClientProxy.EzServiceReference.ActionMetaData SendPendingMail(int underwriterId, int customerId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEzService/SendPendingMail", ReplyAction="http://tempuri.org/IEzService/SendPendingMailResponse")]
        System.Threading.Tasks.Task<ServiceClientProxy.EzServiceReference.ActionMetaData> SendPendingMailAsync(int underwriterId, int customerId);
    ...
    public partial class EzServiceClient : System.ServiceModel.ClientBase<ServiceClientProxy.EzServiceReference.IEzService>, ServiceClientProxy.EzServiceReference.IEzService {
        ...
        public ServiceClientProxy.EzServiceReference.ActionMetaData SendPendingMail(int underwriterId, int customerId) {
            return base.Channel.SendPendingMail(underwriterId, customerId);
        }
        
        public System.Threading.Tasks.Task<ServiceClientProxy.EzServiceReference.ActionMetaData> SendPendingMailAsync(int underwriterId, int customerId) {
            return base.Channel.SendPendingMailAsync(underwriterId, customerId);
        }
