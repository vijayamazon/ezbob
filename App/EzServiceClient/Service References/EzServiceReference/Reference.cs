...
namespace ServiceClientProxy.EzServiceReference {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(ServiceClientProxy.EzServiceReference.NewLoanModelActionResult))]
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="NewLoanModelActionResult", Namespace="http://schemas.datacontract.org/2004/07/EzService.ActionResults")]
    [System.SerializableAttribute()]
    public partial class NewLoanModelActionResult : ServiceClientProxy.EzServiceReference.ActionResult {
    ...
    public interface IEzService {
        ...
        ServiceClientProxy.EzServiceReference.NLLongActionResult AddPayment(int userID, int customerID, Ezbob.Backend.ModelsWithDB.NewLoan.NL_Payments payment);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEzServiceNewLoan/AddPayment", ReplyAction="http://tempuri.org/IEzServiceNewLoan/AddPaymentResponse")]
        System.Threading.Tasks.Task<ServiceClientProxy.EzServiceReference.NLLongActionResult> AddPaymentAsync(int userID, int customerID, Ezbob.Backend.ModelsWithDB.NewLoan.NL_Payments payment);
        ...
        Ezbob.Backend.ModelsWithDB.NewLoan.NL_Loans[] GetCustomerLoans(int customerID, int userID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEzServiceNewLoan/GetCustomerLoans", ReplyAction="http://tempuri.org/IEzServiceNewLoan/GetCustomerLoansResponse")]
        System.Threading.Tasks.Task<Ezbob.Backend.ModelsWithDB.NewLoan.NL_Loans[]> GetCustomerLoansAsync(int customerID, int userID);
        ...
        Ezbob.Backend.ModelsWithDB.NewLoan.NL_Model GetLoanState(int customerID, long loanID, System.DateTime utcNow, int userID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEzServiceNewLoan/GetLoanState", ReplyAction="http://tempuri.org/IEzServiceNewLoan/GetLoanStateResponse")]
        System.Threading.Tasks.Task<Ezbob.Backend.ModelsWithDB.NewLoan.NL_Model> GetLoanStateAsync(int customerID, long loanID, System.DateTime utcNow, int userID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEzServiceNewLoan/GetLoan", ReplyAction="http://tempuri.org/IEzServiceNewLoan/GetLoanResponse")]
        Ezbob.Backend.ModelsWithDB.NewLoan.NL_Loans GetLoan(int loanId, int userID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEzServiceNewLoan/GetLoan", ReplyAction="http://tempuri.org/IEzServiceNewLoan/GetLoanResponse")]
        System.Threading.Tasks.Task<Ezbob.Backend.ModelsWithDB.NewLoan.NL_Loans> GetLoanAsync(int loanId, int userID);
    ...
    public partial class EzServiceClient : System.ServiceModel.ClientBase<ServiceClientProxy.EzServiceReference.IEzService>, ServiceClientProxy.EzServiceReference.IEzService {
        ...
        public ServiceClientProxy.EzServiceReference.NLLongActionResult AddPayment(int userID, int customerID, Ezbob.Backend.ModelsWithDB.NewLoan.NL_Payments payment) {
            return base.Channel.AddPayment(userID, customerID, payment);
        }
        
        public System.Threading.Tasks.Task<ServiceClientProxy.EzServiceReference.NLLongActionResult> AddPaymentAsync(int userID, int customerID, Ezbob.Backend.ModelsWithDB.NewLoan.NL_Payments payment) {
            return base.Channel.AddPaymentAsync(userID, customerID, payment);
        }
        ...
        public Ezbob.Backend.ModelsWithDB.NewLoan.NL_Loans[] GetCustomerLoans(int customerID, int userID) {
            return base.Channel.GetCustomerLoans(customerID, userID);
        }
        
        public System.Threading.Tasks.Task<Ezbob.Backend.ModelsWithDB.NewLoan.NL_Loans[]> GetCustomerLoansAsync(int customerID, int userID) {
            return base.Channel.GetCustomerLoansAsync(customerID, userID);
        }
        
        public Ezbob.Backend.ModelsWithDB.NewLoan.NL_Model GetLoanState(int customerID, long loanID, System.DateTime utcNow, int userID) {
            return base.Channel.GetLoanState(customerID, loanID, utcNow, userID);
        }
        
        public System.Threading.Tasks.Task<Ezbob.Backend.ModelsWithDB.NewLoan.NL_Model> GetLoanStateAsync(int customerID, long loanID, System.DateTime utcNow, int userID) {
            return base.Channel.GetLoanStateAsync(customerID, loanID, utcNow, userID);
        }
        
        public Ezbob.Backend.ModelsWithDB.NewLoan.NL_Loans GetLoan(int loanId, int userID) {
            return base.Channel.GetLoan(loanId, userID);
        }
        
        public System.Threading.Tasks.Task<Ezbob.Backend.ModelsWithDB.NewLoan.NL_Loans> GetLoanAsync(int loanId, int userID) {
            return base.Channel.GetLoanAsync(loanId, userID);
        }
