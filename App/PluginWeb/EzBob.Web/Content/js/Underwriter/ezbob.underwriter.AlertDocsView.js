(function() {
  ...
  EzBob.Underwriter.UploadDocView = (function(_super) {
    ...
    UploadDocView.prototype.upload = function(e) {
      ...
      return this.$el.find("#fileForm").ajaxSubmit({
        ...
        error: function() {
          return alert("Upload failed, possible cause may be big file size (use smaller file) or session time out.");
        }
      });
    };
  ...
  EzBob.Underwriter.AlertDocsView = (function(_super) {
    ...
    AlertDocsView.prototype.initialize = function() {
      this.docs = new EzBob.Underwriter.Docs();
      return this.bindTo(this.docs, 'change reset fetch', this.render, this);
    };

    AlertDocsView.prototype.create = function(customerId) {
      this.customerId = customerId;
      this.dialogId = "#uploadAlertDocDialog" + customerId;
      this.docs.customerId = customerId;
      return this.docs.fetch();
    };

    AlertDocsView.prototype.serializeData = function() {
      return {
        docs: this.docs.toJSON()
      };
    };
    ...
    AlertDocsView.prototype.deleteClick = function() {
      ...
      if (!confirm("Are you sure you want to delete selected docs?")) {
        return;
      }
      xhr = $.ajax({
        type: "POST",
        traditional: true,
        url: "" + this.root + "DeleteDocs",
        data: {
          docIds: ids
        },
        dataType: "json"
