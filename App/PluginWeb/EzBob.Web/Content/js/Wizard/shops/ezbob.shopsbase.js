(function() {
  ...
  EzBob.StoreInfoBaseView = (function(_super) {
    ...
    StoreInfoBaseView.prototype.render = function() {
      var accountsList, canContinue, ebayPaypalRuleMessageVisible, foundAllMandatories, hasEbay, hasFilledShops, hasHmrc, hasPaypal, key, sRemove, sShow, shop, sortedShopsByNumOfShops, sortedShopsByPriority, that, _i, _j, _len, _len1, _ref1;
