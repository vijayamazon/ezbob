    ...
    public class LoanHistoryExelReportGenerator
    {
        ...
        public byte[] GenerateReport(IList<LoanModel> loans , string fullName)
        {
            ...
            foreach (var loan in loans)
            {
                ...
                worksheet.Cells[row, 1].PutValue(loan.LoanAmount.ToString("N", CultureInfo.CreateSpecificCulture("en-gb")));
                worksheet.Cells[row, 2].PutValue(loan.Repayments.ToString("N", CultureInfo.CreateSpecificCulture("en-gb")));
                worksheet.Cells[row, 3].PutValue(loan.Date.ToString("MMM dd yyyy", CultureInfo.CreateSpecificCulture("en-gb")));
                worksheet.Cells[row, 4].PutValue(loan.Balance.ToString("N", CultureInfo.CreateSpecificCulture("en-gb")));
            ...
            worksheet.Cells[row, 1].PutValue(sumLoanAmount.ToString("N",CultureInfo.InvariantCulture) );
            worksheet.Cells[row, 2].PutValue(sumRepayments.ToString("N",CultureInfo.InvariantCulture));
            worksheet.Cells[row, 4].PutValue(sumBalance.ToString("N",CultureInfo.InvariantCulture));
