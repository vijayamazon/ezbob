    ...
    public class LoanHistoryExelReportGenerator
    {
        ...
        public byte[] GenerateReport(IList<LoanModel> loans , string fullName)
        {
            ...
            foreach (var loan in loans)
            {
                ...
                worksheet.Cells[row, 1].PutValue(FormattingUtils.FormatNoDecimals(loan.LoanAmount));
			...
			worksheet.Cells[row, 1].PutValue(FormattingUtils.FormatNoDecimals(sumLoanAmount));
