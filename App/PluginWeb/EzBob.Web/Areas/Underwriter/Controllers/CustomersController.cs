	...
	public class CustomersController : Controller {
		...
		public JsonResult ChangeStatus(DecisionModel model) {
			...
			case CreditResultStatus.Approved:
				...
				ApproveCustomer(model, customer, user, now, request, numOfPreviousApprovals, ref sWarning, newDecision);
				break;

			case CreditResultStatus.Rejected:
				runSilentAutomation = true;
				RejectCustomer(model, customer, now, user, request, numOfPreviousApprovals, ref sWarning, newDecision);
				break;

			case CreditResultStatus.Escalated:
				EscalateCustomer(model, customer, user, request, ref sWarning, newDecision);
				break;
