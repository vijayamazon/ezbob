...
namespace EzBob.Web.Infrastructure
{
    public class BundleHelper
    {
        ...
        private static string GetDbStrings()
        {
            ...
            var dict = strings.GetAllStrings().ToDictionary(s => s.Key, s => s.Value);
        ...
        public static MvcHtmlString RenderStoreInfoJs()
        {
            return Bundle.JavaScript()
                ...
                .Add("~/Content/js/Wizard/shops/ezbob.shopslistview.coffee")
                .Add("~/Content/js/Wizard/ezbob.storebase.js")
