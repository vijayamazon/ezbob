...
namespace EzBob.Tests.LoanPaymentFacadeTests
{
    public class DelinquencyFixture : LoanPaymentsTestBase
    {
        ...
        public void delinquency_for_almost_paid_installment3()
        {
            ...
            var p = new LoanRepaymentScheduleCalculator(_loan, Parse("2013-08-30 00:00:00.000"), _configurationVariablesRepository).NextEarlyPayment();
        ...
        public void delinquency_for_almost_paid_installment4()
        {
            ...
            LoanModel.FromLoan(_loan, new LoanRepaymentScheduleCalculator(_loan, Parse("2013-08-30 16:52:00.000"), _configurationVariablesRepository));
