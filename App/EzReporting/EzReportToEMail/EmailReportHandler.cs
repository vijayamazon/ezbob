namespace EzReportToEMail {
    ...
    public class EmailReportHandler : BaseReportHandler {
        ...
        private void HandleReportsBulk(SortedDictionary<string, Report> reportList, int reportsToHandleParalely, DateTime dToday, ReportType? nReportTypeToExecute, ReportDispatcher sender) {
        ...
        private void HandleOneReport(DateTime dToday, ReportType? nReportTypeToExecute, Report report, ReportDispatcher sender) {
            try {
                bool bExecute =
