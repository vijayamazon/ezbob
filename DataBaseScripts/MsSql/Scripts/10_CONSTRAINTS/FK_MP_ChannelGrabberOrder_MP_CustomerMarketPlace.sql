IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_MP_ChannelGrabberOrder_MP_CustomerMarketPlace]') AND parent_object_id = OBJECT_ID(N'[dbo].[MP_ChannelGrabberOrder]'))
ALTER TABLE [dbo].[MP_ChannelGrabberOrder] DROP CONSTRAINT [FK_MP_ChannelGrabberOrder_MP_CustomerMarketPlace]
GO
