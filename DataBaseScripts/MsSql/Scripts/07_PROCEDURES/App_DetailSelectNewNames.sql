IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[App_DetailSelectNewNames]') AND type in (N'P', N'PC'))
...
GO
CREATE PROCEDURE App_DetailSelectNewNames
