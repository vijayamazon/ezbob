IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MP_GetEbayOrdersCancellationRate]') AND type in (N'P', N'PC'))
...
GO
CREATE PROCEDURE MP_GetEbayOrdersCancellationRate
