IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetSecondStepCustomers]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[GetSecondStepCustomers]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE GetSecondStepCustomers
	@DateStart    DATETIME,
	@DateEnd      DATETIME
