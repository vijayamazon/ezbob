IF  EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[LoanTransaction]') AND name = N'IX_LT_ID_TYPE')
DROP INDEX [IX_LT_ID_TYPE] ON [dbo].[LoanTransaction] WITH ( ONLINE = OFF )
GO
