...
IF NOT EXISTS (SELECT * FROM ReportScheduler WHERE Type = 'RPT_PAYPOINT_RECONCILIATION')
BEGIN
	INSERT INTO ReportScheduler VALUES('RPT_PAYPOINT_RECONCILIATION', 'Paypoint Reconciliation', 'RptPaypointReconciliation', 0, 0, 0,
		'ID,Caption,Ezbob Amount,Paypoint Amount,Transaction ID,Transaction Time,Client ID,Loan ID,Client Name,Client Email,Description,Css',
		'!SortOrder,Caption,EzbobAmount,PaypointAmount,!Id,PostDate,!ClientID,!LoanID,ClientName,ClientEmail,Description,{Css',
...
ELSE BEGIN
	UPDATE ReportScheduler SET
		...
		IsWeekly = 0,
		IsMonthly = 0,
		Header = 'ID,Caption,Ezbob Amount,Paypoint Amount,Transaction ID,Transaction Time,Client ID,Loan ID,Client Name,Client Email,Description,Css',
		Fields = '!SortOrder,Caption,EzbobAmount,PaypointAmount,!Id,PostDate,!ClientID,!LoanID,ClientName,ClientEmail,Description,{Css',
		IsMonthToDate = 0
	WHERE
