execute immediate 'create table SystemCalendar_Calendar (
...
execute immediate 'create table SystemCalendar_BaseRelation (
        CalendarId NUMBER(10,0) not null,
       BaseCalendarId NUMBER(10,0) not null
    )';

execute immediate 'create table SystemCalendar_Day (
        Id NUMBER(10,0) not null,
...
execute immediate 'create table SystemCalendar_Entry (
        Id NUMBER(10,0) not null,
...
execute immediate 'create table Strategy_CalendarRelation (
        StrategyId NUMBER(10,0) not null,
       CalendarId NUMBER(10,0) not null
    )';

execute immediate 'alter table SystemCalendar_BaseRelation 
...
execute immediate 'alter table SystemCalendar_Day 
        add constraint FKAFEECA076E0ADFD1 
        foreign key (HostCalendarId) 
        references SystemCalendar_Calendar';

execute immediate 'alter table SystemCalendar_Entry 
...
execute immediate 'alter table Strategy_CalendarRelation 
...
execute immediate 'create sequence SEQ_SystemCalendar_Calendar';

execute immediate 'create sequence SEQ_SystemCalendar_Day';

execute immediate 'create sequence SEQ_SystemCalendar_Entry';