namespace YodleeLib
{
	...
	public class LoginUser : ApplicationSuper
	{
		...
		{
			var oldCredentials = new PasswordCredentials { loginName = userName, password = password };

			var newCredentials = new PasswordCredentials { loginName = userName, password = changePassword };
