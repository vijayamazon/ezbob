namespace TeamCityModels.ActionTypes
{
    ...
    public class Users : IUsers
    {
        ...
        {
            var userWrapper = this._caller.Get<UserWrapper>("/app/rest/users");
        ...
        {
            var user =
                this._caller.GetFormat<User>("/app/rest/users/username:{0}", userName);
        ...
        {
            var user = this._caller.GetFormat<User>("/app/rest/users/username:{0}", userName);
        ...
        {
            var userGroupWrapper = this._caller.Get<UserGroupWrapper>("/app/rest/userGroups");
        ...
        {
            var group = this._caller.GetFormat<Group>("/app/rest/userGroups/key:{0}", userGroupName);
