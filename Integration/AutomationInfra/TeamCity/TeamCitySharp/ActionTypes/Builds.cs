namespace TeamCityModels.ActionTypes
{
    ...
    public class Builds : IBuilds
    {
        ...
        public Builds(TeamCityCaller caller)
        {
            this._caller = caller;
        }
        ...
        {
            var buildWrapper = this._caller.GetFormat<BuildWrapper>("/app/rest/builds?locator={0}", locator);
        ...
        {
            this._caller.GetFormat("/action.html?add2Queue={0}", buildConfigId);
        }
