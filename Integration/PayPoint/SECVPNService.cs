...
public partial class SECVPNService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public event performTransactionViaAlternatePaymentMethodCompletedEventHandler performTransactionViaAlternatePaymentMethodCompleted;
    ...
    /// <remarks/>
    public System.IAsyncResult BeginrepeatCardFullAddr(string mid, string vpn_pswd, string trans_id, string amount, string remote_pswd, string new_trans_id, string exp_date, string order, string bill, string ship, string options, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public System.IAsyncResult BegingetTZReport(string mid, string vpn_pswd, string remote_pswd, string report_type, string cond_type, string condition, string currency, string predicate, bool html, bool showErrs, string tz, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public void getTZReportAsync(string mid, string vpn_pswd, string remote_pswd, string report_type, string cond_type, string condition, string currency, string predicate, bool html, bool showErrs, string tz) {
        this.getTZReportAsync(mid, vpn_pswd, remote_pswd, report_type, cond_type, condition, currency, predicate, html, showErrs, tz, null);
    }
    
    /// <remarks/>
    public void getTZReportAsync(string mid, string vpn_pswd, string remote_pswd, string report_type, string cond_type, string condition, string currency, string predicate, bool html, bool showErrs, string tz, object userState) {
        if ((this.getTZReportOperationCompleted == null)) {
            this.getTZReportOperationCompleted = new System.Threading.SendOrPostCallback(this.OngetTZReportOperationCompleted);
        }
        this.InvokeAsync("getTZReport", new object[] {
                    ...
                    html,
                    showErrs,
                    tz}, this.getTZReportOperationCompleted, userState);
    }
    
    private void OngetTZReportOperationCompleted(object arg) {
        if ((this.getTZReportCompleted != null)) {
            System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
            this.getTZReportCompleted(this, new getTZReportCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
        }
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginperformTransactionViaAlternatePaymentMethod(string mid, string vpn_pswd, string paymentOrganisation, string paymentMethod, string paymentType, string paymentRequestType, string trans_id, string amount, string currency, string options, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public void performTransactionViaAlternatePaymentMethodAsync(string mid, string vpn_pswd, string paymentOrganisation, string paymentMethod, string paymentType, string paymentRequestType, string trans_id, string amount, string currency, string options) {
        this.performTransactionViaAlternatePaymentMethodAsync(mid, vpn_pswd, paymentOrganisation, paymentMethod, paymentType, paymentRequestType, trans_id, amount, currency, options, null);
    }
    
    /// <remarks/>
    public void performTransactionViaAlternatePaymentMethodAsync(string mid, string vpn_pswd, string paymentOrganisation, string paymentMethod, string paymentType, string paymentRequestType, string trans_id, string amount, string currency, string options, object userState) {
        if ((this.performTransactionViaAlternatePaymentMethodOperationCompleted == null)) {
            this.performTransactionViaAlternatePaymentMethodOperationCompleted = new System.Threading.SendOrPostCallback(this.OnperformTransactionViaAlternatePaymentMethodOperationCompleted);
        }
        this.InvokeAsync("performTransactionViaAlternatePaymentMethod", new object[] {
                    ...
                    amount,
                    currency,
                    options}, this.performTransactionViaAlternatePaymentMethodOperationCompleted, userState);
    }
    ...
    private void OnperformTransactionViaAlternatePaymentMethodOperationCompleted(object arg) {
        if ((this.performTransactionViaAlternatePaymentMethodCompleted != null)) {
            System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
            this.performTransactionViaAlternatePaymentMethodCompleted(this, new performTransactionViaAlternatePaymentMethodCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
        }
    }
...
public partial class getTZReportCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    ...
    internal getTZReportCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState) {
        this.results = results;
    }
...
/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.0.30319.17929")]
public delegate void performTransactionViaAlternatePaymentMethodCompletedEventHandler(object sender, performTransactionViaAlternatePaymentMethodCompletedEventArgs e);

/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.0.30319.17929")]
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
public partial class performTransactionViaAlternatePaymentMethodCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    
    private object[] results;
    
    internal performTransactionViaAlternatePaymentMethodCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState) {
        this.results = results;
    }
