...
namespace ExperianLib
{
    public class ConsumerServiceResult
    {
        ...
        public ConsumerServiceResult(OutputRoot outputRoot, DateTime? defaultBirthDate)
        {
            ...
            {
                TryRead(
                    () => BureauScore = Convert.ToDouble(Output.Output.ConsumerSummary.PremiumValueData.Scoring.E5S051),
                    "BureauScore");
                TryRead(
                    () =>
                    CreditCardBalances =
                ...
                TryRead(
                    ...
                    NumCreditCards =
                    Convert.ToDouble(
                        Output.Output.ConsumerSummary.PremiumValueData.AdditDelphiBlocks.APACSCCBehavrlData.NOMPMNPRL3M),
                    "NumCreditCards");
                TryRead(
                    () =>
                    CreditLimitUtilisation =
                    Convert.ToDouble(
                        Output.Output.ConsumerSummary.PremiumValueData.AdditDelphiBlocks.APACSCCBehavrlData.CLUNPRL1M),
                    "CreditLimitUtilisation");
                TryRead(
                    () =>
                    CreditCardOverLimit =
                    Convert.ToDouble(
                        Output.Output.ConsumerSummary.PremiumValueData.AdditDelphiBlocks.Utilisationblock.SPF131),
                    "CreditCardOverLimit");
                TryRead(() => CreditCardStatus = Convert.ToDouble(Output.Output.ConsumerSummary.Summary.CAIS.NDHAC04),
                        "CreditCardStatus");
                TryRead(() =>
                            {
                                var ccbt =
                ...
                TryRead(
                    ...
                    "UnsecuredLoans");
                TryRead(
                    () => PersonalLoanStatus = Convert.ToDouble(Output.Output.ConsumerSummary.Summary.CAIS.NDHAC05),
                    "PersonalLoanStatus");
                TryRead(
                    () => TotalAccountBalances = Convert.ToDouble(Output.Output.ConsumerSummary.Summary.CAIS.E1B10),
                    "TotalAccountBalances");
                TryRead(() => NoAccountsReturned = Output.Output.ConsumerSummary.Summary.CAIS.E1B01,
                        "NoAccountsReturned");
                TryRead(() => CCJLast2Years = Convert.ToDouble(Output.Output.ConsumerSummary.Summary.PublicInfo.E1A03),
                        "CCJLast2Years");
                TryRead(
                    () => EnquiriesLast6Months = Convert.ToDouble(Output.Output.ConsumerSummary.Summary.CAPS.E1E02),
                    "EnquiriesLast6Months");
                TryRead(
                    () => EnquiriesLast3Months = Convert.ToDouble(Output.Output.ConsumerSummary.Summary.CAPS.E1E01),
                    "EnquiriesLast3Months");
                TryRead(() => MortgageBalance = Convert.ToDouble(Output.Output.ConsumerSummary.Summary.CAIS.E1B11),
                        "MortgageBalance");
                ...
                TryRead(() =>
                {
                    var spa08 = Convert.ToDecimal(Output.Output.ConsumerSummary.PremiumValueData.AdditDelphiBlocks.Utilisationblock.SPA08);
                    var spa09 =Convert.ToDecimal(Output.Output.ConsumerSummary.PremiumValueData.AdditDelphiBlocks.Utilisationblock.SPA09);
                    if (spa08 > 0) StatusOnMortgageAccounts = 1;
                    if (spa09 > 0) StatusOnMortgageAccounts = 2;
                }, "StatusOnMortgageAccounts");
                TryRead(() => SumOfRepayements = Convert.ToDouble(Output.Output.ConsumerSummary.PremiumValueData.AdditDelphiBlocks.Utilisationblock.SPH39) + Convert.ToDouble(Output.Output.ConsumerSummary.PremiumValueData.AdditDelphiBlocks.Utilisationblock.SPH40) + Convert.ToDouble(Output.Output.ConsumerSummary.PremiumValueData.AdditDelphiBlocks.Utilisationblock.SPH41), "SumOfRepayements");
                ...
                TryRead(() =>
                {
                    OtherPublicInfo = Convert.ToInt32(Output.Output.ConsumerSummary.Summary.PublicInfo.E1A02) == 1 || Convert.ToDouble(Output.Output.ConsumerSummary.Summary.PublicInfo.E2G02) > 0;
                }, "OtherPublicInfo");
            }
        }
