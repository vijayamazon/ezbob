namespace ExperianLib.Parser
{
	...
	public class FinancialAccountsParser
	{
		...
		public void Parse(string response, long serviceLogId, int customerId)
		{
			...
			{
				log.Info("Found {0} financial account blocks for customer {1}", caisDetailsList.Count, customerId);
		...
		private void UpdateFinancialAccounts(IEnumerable<FinancialAccount> financialAccounts, long serviceLogId, int customerId)
		{
