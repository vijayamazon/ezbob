...
namespace FBAInventoryServiceMWS.Service.Model
{
    ...
    public class InventorySupplyList
    {
        ...
        private  List<InventorySupply> memberField;
        ...
        public List<InventorySupply> member
        {
            get
            {
                ...
                {
                    this.memberField = new List<InventorySupply>();
                }
        ...
        public InventorySupplyList Withmember(params InventorySupply[] list)
        {
            foreach (InventorySupply item in list)
            {
                member.Add(item);
            }
            return this;
        ...
        protected internal String ToXMLFragment() {
            ...
            List<InventorySupply> memberObjList = this.member;
            foreach (InventorySupply memberObj in memberObjList) {
                xml.Append("<member>");
