...
namespace MarketplaceWebService
{
    ...
    */
    public class MarketplaceWebServiceClient : IMarketplaceWebService
    {
        ...
        private T Invoke<T, K>(IDictionary<String, String> parameters, K clazz)
        {
			...
			catch ( WebException we )
			{
				...
				catch ( Exception e )
				{
					...
					{
						MarketplaceWebServiceException se = ReportAnyErrors( responseBody, statusCode, e );
						throw se;
					}
				}
			}
         ...
         */
        private MarketplaceWebServiceException ReportAnyErrors(String responseBody, HttpStatusCode status, Exception e)
        {
            ...
            if (responseBody != null && responseBody.StartsWith("<"))
            {
                ...
                if (errorMatcherOne.Success)
                {
                    ...
                    ex = new MarketplaceWebServiceException(message, status, code, "Unknown", requestId, responseBody);
