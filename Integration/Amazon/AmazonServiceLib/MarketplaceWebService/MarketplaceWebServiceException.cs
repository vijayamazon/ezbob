...
namespace MarketplaceWebService
{
    ...
    public class MarketplaceWebServiceException : Exception 
    {
        ...
        public MarketplaceWebServiceException(String message, HttpStatusCode statusCode, String errorCode, String errorType, String requestId, String xml) : this (message, statusCode)
        {
