namespace EzBobTestDI.Investor
{
    using System.Collections.Generic;
    using System.Linq;
    using Ezbob.Backend.ModelsWithDB.Investor;
    using EzBobTestDI.Core;
    using InvestorBLL;
    ...
    public class TestInvestorRules : TestBase
    {
        ...
        public void TestRulesMultiInvestors()
        {
            ...
            ruleEngineDalMock.Setup(x => x.GetRules(1, RuleType.InvestorRule))
                .Returns(rulesDict1);
            ...
            ruleEngineDalMock.Setup(x => x.GetRules(2, RuleType.InvestorRule))
                             .Returns(rulesDict2);
