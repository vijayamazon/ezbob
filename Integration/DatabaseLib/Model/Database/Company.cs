namespace EZBob.DatabaseLib.Model.Database {
	...
	public class Company {
		...
		public virtual ISet<CustomerAddress> ExperianCompanyAddress {
			get { return this._experianCompanyAddress; }
			set { this._experianCompanyAddress = value; }
		}

		public virtual ISet<CompanyEmployeeCount> CompanyEmployeeCount {
			get { return this._companyEmployeeCount; }
			set { this._companyEmployeeCount = value; }
		}
	...
	public class CompanyMap : ClassMap<Company> {
		public CompanyMap() {
			...
			Id(x => x.Id);
			Map(x => x.TypeOfBusiness)
				.CustomType<TypeOfBusinessType>();
			Map(x => x.VatReporting)
				.CustomType<VatReportingType>();
			Map(x => x.CompanyNumber)
				.Length(100);
			Map(x => x.CompanyName)
				.Length(300);
			Map(x => x.TimeAtAddress);
			Map(x => x.TimeInBusiness)
				.Length(250);
			Map(x => x.BusinessPhone)
				.Length(250);
			Map(x => x.PropertyOwnedByCompany)
				.Length(250);
			Map(x => x.YearsInCompany)
				.Length(250);
			Map(x => x.RentMonthLeft)
				.Length(250);
			Map(x => x.ExperianRefNum)
				.Length(250);
			Map(x => x.ExperianCompanyName)
				.Length(250);
