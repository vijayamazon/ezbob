namespace EZBob.DatabaseLib.DatabaseWrapper.Order
{
	...
	public class SageSalesInvoicesConverter
	{
		...
		{
			var salesInvoices = new List<SageSalesInvoice>(dbSalesInvoices.Select(o => new SageSalesInvoice
				{
					SageId = o.SageId,
					...
					line_items = GetSageSalesInvoiceItems(o.Items)
				}));

			return salesInvoices;
		}

		private static List<SageSalesInvoiceItem> GetSageSalesInvoiceItems(IEnumerable<MP_SageSalesInvoiceItem> items)
		{
