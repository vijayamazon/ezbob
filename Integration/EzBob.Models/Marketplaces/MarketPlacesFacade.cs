namespace EzBob.Models.Marketplaces {
	...
	public class MarketPlacesFacade {
		...
		#region method GetMarketPlaceModels
				...
				foreach (var oModel in oHmrcList) {
					try {
						...
						if (hmrcData != null) {
							...
							//IntActionResult result = serviceClient.Instance.GetExperianAccountsCurrentBalance(customer.Id);
							//decimal factor = ConfigManager.CurrentValues.Instance.FCFFactor;

							//double newActualLoansRepayment = result.Value / factor;
		...
		#endregion method GetMarketPlaceModels

		#region method MarketplacesSeniority
		...
		#endregion method MarketplacesSeniority

		#region method GetMarketPlaceHistoryModel
		...
		#endregion method GetMarketPlaceHistoryModel

		#endregion public

		#region private

		#region method CalculateAnnualizedBankStatement
		...
		#endregion method CalculateAnnualizedBankStatement
		...
		private static readonly ILog ms_oLog = LogManager.GetLogger(typeof (MarketPlacesFacade));
