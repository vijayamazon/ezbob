...
namespace EzBob.Web.Areas.Underwriter
{
	...
	public class MarketPlacesFacade
	{
		...
		public MarketPlacesFacade(EbayAmazonCategoryRepository ebayAmazonCategoryRepository,
								  CustomerMarketPlaceRepository customerMarketplaces, MP_YodleeOrderRepository yodleeOrderRepository, ISession session)
		{
		...
		private YodleeModel BuildYodlee(IEnumerable<MP_YodleeOrderItem> yodleeData)
		{
			...
			ICurrencyConvertor currencyConverter = new CurrencyConvertor(new CurrencyRateRepository(_session));
				...
				var yodleeBankModel = new YodleeBankModel
					{
						...
						availableBalance = bank.availableBalance.HasValue ? currencyConverter.ConvertToBaseCurrency(
					...
					var yodleeTransactionModel = new YodleeTransactionModel
						{
							...
							transactionAmount = transaction.transactionAmount.HasValue ? currencyConverter.ConvertToBaseCurrency(
